...
function UploadWidget({setPicture}){
    ...
    return (
        <>
            <div style={{margin:'0',paddingTop:'15px'}}>
            <p style={{ display: 'inline-block',float:'left'}}>Add a picture</p>
            <button style={{border:'none', padding:'0', background:'none', display:'inline-block',float:'right'}} onClick={() => widgetRef.current.open()}>
                <SvgIcon>
